...
def generate(
    ...
    with torch.no_grad():
        ...
        if input_image:
            ...
            input_image_tensor = input_image_tensor.premute(0, 3, 1, 2)
...
def get_time_embedding(timestep):
    ...
    # (1,160)
    x = torch.tensor([timestep], dtype=torch.float32)[1:None]*freqs[None]
